...
class PauseSubscriptionController extends CpController
{
    use ClearsStripeCache, SendsDonorNotifications;

    public function __invoke(string $id, PauseSubscription $pauseSubscription, StripeClient $stripe): RedirectResponse
    {
        ...
        $this->notifyDonorPaused($subscription->customer);
