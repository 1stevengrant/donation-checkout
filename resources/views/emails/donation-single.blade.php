                  ...
                  <table role="presentation" style="width: 100%; border-radius: 0.75rem; background-color: {{ $accentColor }}10;" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding: 1.25rem 1.5rem; text-align: center;">
                        <p style="margin: 0px; font-size: 0.875rem; line-height: 1.25rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: rgb(100, 116, 139);">Your donation</p>
                        <p style="margin: 0.25rem 0px 0px; font-size: 1.875rem; line-height: 2.25rem; font-weight: 800; color: {{ $accentColor }};">{{ strtoupper($currency) }} {{ number_format($amount, 2) }}</p>
                      </td>
                    </tr>
                  </table>
